...
def main():
    ...
    if args.task_name in args.nli_tasks:
        ...
        processor = processors[args.task_name](args.spurious_correlation)
...
def get_args():
    ...
    parser.add_argument("--plotting_tsne", action="store_true", help="Plotting")
    parser.add_argument("--spurious_correlation", type=str, default=None, help="hot to build the spurious correlation")
    parser.add_argument("--fix_model", type=str, default=None, help="fix model")
    parser.add_argument("--train_only", type=str, default=None, help="train only ")
